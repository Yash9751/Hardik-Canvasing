...
export default function PurchaseLoading() {
  ...
  const fetchPurchaseLoading = async () => {
    try {
      setLoading(true);
      const response = await api.get('/dashboard/purchase-loading-details');
      ...
      console.error('Error fetching purchase loading:', error);
      Alert.alert('Error', error.response?.data?.error || 'Failed to fetch purchase loading data');
    } finally {
      setLoading(false);
    }
  };
    ...
    <SafeAreaView style={styles.container}>
      <ThemedView style={styles.container}>
        ...
        <View style={styles.header}>
          ...
          <ThemedText style={styles.headerTitle}>Purchase Loading</ThemedText>
          <TouchableOpacity
            onPress={onRefresh}
          ...
          <View style={styles.listContainer}>
            ...
            {loading ? (
              ...
              <Card style={styles.emptyCard}>
                ...
                <ThemedText style={styles.emptyText}>No purchase loading found</ThemedText>
              </Card>
            ) : (
